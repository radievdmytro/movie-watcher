        ...
        <div>
            ...
            {viewMode === 'grid' ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    {isWatchedView && watchedViewMode === 'folders' && activeFolder && (
                        <div style={{ display: 'flex', gap: '15px', alignItems: 'center', alignSelf: 'flex-start', flexWrap: 'wrap', marginBottom: '10px' }}>
                            ...
                            <button 
                                ...
                                style={{ padding: '8px 15px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: isMobile ? '0.8rem' : '0.9rem' }}
                            >
                ...
                <div className="movie-table-container">
                    ...
                    <div className="glass-panel" style={{ overflowX: 'auto', display: 'flex', flexDirection: 'column' }}>
                        {isWatchedView && watchedViewMode === 'folders' && activeFolder && (
                            <div style={{ display: 'flex', gap: '15px', alignItems: 'center', alignSelf: 'flex-start', flexWrap: 'wrap', marginBottom: '15px' }}>
                                <button className="folder-back-btn" onClick={() => setActiveFolder(null)}>
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>
                                    {isMobile ? 'Назад' : 'Вернуться к папкам'}
                                </button>
